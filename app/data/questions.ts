...
"Html-lesson13": [
  {
    "question": "يعني إيه 'الوصول' (Accessibility) في صفحات الويب؟",
    "options": [
      "إن كل الناس تقدر تستخدم الموقع حتى أصحاب الاحتياجات الخاصة",
      "إن الموقع بيشتغل بسرعة",
      "إن الموقع يكون عليه زوار كتير",
      "إن الموقع يكون فيه صور حلوة"
    ],
    "correctAnswer": "إن كل الناس تقدر تستخدم الموقع حتى أصحاب الاحتياجات الخاصة"
  },
  {
    "question": "ليه لازم نكتب وصف للصورة باستخدام alt؟",
    "options": [
      "علشان القارئ الآلي يقدر يشرح الصورة للي مش شايفينها",
      "علشان نزين الصورة",
      "علشان نحطها في محركات البحث",
      "علشان نغير لون الخلفية"
    ],
    "correctAnswer": "علشان القارئ الآلي يقدر يشرح الصورة للي مش شايفينها"
  },
  {
    "question": "لو عندي فورم، إزاي أخلّي الشاشة القارئة تعرف كل input بيخص إيه؟",
    "options": [
      "باستخدام <label> مربوط بـ id الخاص بـ input",
      "نكتب نص جنب input",
      "نغير لون الخانات",
      "نحط كل input في <div>"
    ],
    "correctAnswer": "باستخدام <label> مربوط بـ id الخاص بـ input"
  },
  {
    "question": "ليه مهم نستخدم التاجات الصحيحة زي <nav> و <main> و <footer>؟",
    "options": [
      "علشان القارئ الآلي يفهم أجزاء الصفحة",
      "علشان نكتب CSS أسهل",
      "علشان شكل الصفحة يتغير",
      "علشان نكتب HTML أسرع"
    ],
    "correctAnswer": "علشان القارئ الآلي يفهم أجزاء الصفحة"
  },
  {
    "question": "يعني إيه tabindex في HTML؟",
    "options": [
      "بيحدد ترتيب التنقل بين العناصر باستخدام Tab",
      "بيغير لون النص",
      "بيكتب عنوان الصفحة",
      "بيشغل الصوت التلقائي"
    ],
    "correctAnswer": "بيحدد ترتيب التنقل بين العناصر باستخدام Tab"
  },
  {
    "question": "إزاي تساعد المستخدم اللي بيستخدم الكيبورد بس؟",
    "options": [
      "تخلي كل العناصر المهمة توصل بـ Tab",
      "تشيل الماوس من التصميم",
      "تخفي الأزرار",
      "تخلي كل حاجة تلقائية"
    ],
    "correctAnswer": "تخلي كل العناصر المهمة توصل بـ Tab"
  },
  {
    "question": "ليه نستخدم role في بعض العناصر؟",
    "options": [
      "علشان نوضح نوع العنصر للقارئ الآلي",
      "علشان نضيف CSS",
      "علشان نمنع التفاعل",
      "علشان نحط ID تلقائي"
    ],
    "correctAnswer": "علشان نوضح نوع العنصر للقارئ الآلي"
  },
  {
    "question": "إيه فائدة استخدام <button> بدل <div> عند تنفيذ أوامر؟",
    "options": [
      "علشان <button> بيدعم الكيبورد والشاشة القارئة تلقائيًا",
      "علشان شكله أحسن",
      "علشان أسهل في CSS",
      "علشان يعمل Hover تلقائي"
    ],
    "correctAnswer": "علشان <button> بيدعم الكيبورد والشاشة القارئة تلقائيًا"
  },
  {
    "question": "هل النصوص اللي جوه الصورة بتكون واضحة للقارئ الآلي؟",
    "options": [
      "لأ، لازم نكتبها في alt أو جنب الصورة",
      "آه، لو الصورة PNG",
      "آه، بس لازم تكون ملونة",
      "آه، لو حجم الصورة كبير"
    ],
    "correctAnswer": "لأ، لازم نكتبها في alt أو جنب الصورة"
  },
  {
    "question": "هل من الجيد نختار ألوان متباينة في التصميم؟",
    "options": [
      "آه، علشان المستخدمين اللي عندهم مشاكل في الرؤية يشوفوا كويس",
      "لأ، علشان الألوان القوية مزعجة",
      "مش مهم طالما التصميم شكله حلو",
      "الألوان مش بتفرق في الوصول"
    ],
    "correctAnswer": "آه، علشان المستخدمين اللي عندهم مشاكل في الرؤية يشوفوا كويس"
  }
],
"Html-lesson14": [
  {
