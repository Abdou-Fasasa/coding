...
const lessons = [
  {
    ...
    "description": "مقدمة في علوم الحاسوب والبرمجة هي رحلتك الأولى لاكتشاف عالم التكنولوجيا المثير! في هذه الدورة، هنتعلم أساسيات التفكير الحاسوبي والبرمجة. هنتعمق في مفاهيم زي إزاي الكمبيوتر بيفكر، إيه هي لغات البرمجة المختلفة، وإزاي نقدر نستخدمها عشان نعمل حاجات مفيدة زي بناء مواقع الويب التفاعلية.",
