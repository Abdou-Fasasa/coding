...
import { FaEye, FaEyeSlash, FaWhatsapp, FaSignInAlt, FaUserPlus, FaCrown } from 'react-icons/fa';
        ...
        <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6">
          ...
          >
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300 hover:text-indigo-300"
            >
